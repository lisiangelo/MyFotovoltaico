...
public class FragmentProduzioni extends Fragment {
    Spinner anno1;
    Spinner anno2;
    LineChart chart;
    LineData data;
    TableLayout tableLayoutProd_prec;
    TableLayout tableLayoutProd_succ;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        titolo.setText("Analisi e confronto Produzione");
        ...
        chart.setDescription("# dati produzione");
        chart.setBackground(getResources().getDrawable(R.drawable.sfondo_tabella));


        tableLayoutProd_prec = (TableLayout) rootView.findViewById(R.id.table_anno_precedente);
        tableLayoutProd_prec.setStretchAllColumns(true);
        tableLayoutProd_prec.bringToFront();
        //tableLayoutProd_prec.setBackgroundDrawable(getResources().getDrawable(it.android.j940549.fotovoltaico.R.drawable.bordo));


        tableLayoutProd_succ = (TableLayout) rootView.findViewById(R.id.table_anno_successivo);
        tableLayoutProd_succ.setStretchAllColumns(true);
        tableLayoutProd_succ.bringToFront();
        //tableLayoutProd_succ.setBackgroundDrawable(getResources().getDrawable(it.android.j940549.fotovoltaico.R.drawable.bordo));

        new AsyncProduzione(this).execute(anno1, anno2);
    ...
    public void populateResult(LineData data, ArrayList<Dato_Tot_Tabella> datianno_prec, ArrayList<Dato_Tot_Tabella> datianno_succ) {
        ...
        for (int i=0; i<=datianno_prec.size()-2; i++) {
            ...
            tableLayoutProd_prec.addView(rowdato);
        }
        for (int i=0; i<=datianno_succ.size()-2; i++) {
            ...
            tableLayoutProd_succ.addView(rowdatos);
