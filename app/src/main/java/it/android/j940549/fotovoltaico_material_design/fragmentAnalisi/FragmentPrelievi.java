...
public class FragmentPrelievi extends Fragment {
    Spinner anno1;
    Spinner anno2;
    LineChart chart;
    LineData data;
    TableLayout tableLayoutPrel_prec;
    TableLayout tableLayoutPrel_succ;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        titolo.setText("Analisi e confronto Prelievi");
        ...
        chart.setDescription("# dati prelievi");
        chart.setBackground(getResources().getDrawable(R.drawable.sfondo_tabella));


        tableLayoutPrel_prec = (TableLayout) rootView.findViewById(R.id.table_anno_precedente);
        tableLayoutPrel_prec.setStretchAllColumns(true);
        tableLayoutPrel_prec.bringToFront();
       // tableLayoutPrel_prec.setBackgroundDrawable(getResources().getDrawable(it.android.j940549.fotovoltaico.R.drawable.bordo));


        tableLayoutPrel_succ = (TableLayout) rootView.findViewById(R.id.table_anno_successivo);
        tableLayoutPrel_succ.setStretchAllColumns(true);
        tableLayoutPrel_succ.bringToFront();
       // tableLayoutPrel_succ.setBackgroundDrawable(getResources().getDrawable(it.android.j940549.fotovoltaico.R.drawable.bordo));



        new AsyncPrelievi(this).execute(anno1,anno2);
    ...
    public void populateResult(LineData data, ArrayList<Dato_Tot_Tabella> datianno_prec, ArrayList<Dato_Tot_Tabella> datianno_succ) {
        ...
        for (int i=0; i<=datianno_prec.size()-2; i++) {
            ...
            tableLayoutPrel_prec.addView(rowdato);
        }
        for (int i=0; i<=datianno_succ.size()-2; i++) {
            ...
            tableLayoutPrel_succ.addView(rowdatos);
