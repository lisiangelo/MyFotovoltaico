...
public class FragmentAutoc_Imm extends Fragment {
    Spinner anno1;
    Spinner anno2;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        titolo.setText("Analisi e confronto Impiego della Produzione");
        ...
        float i_pro = ((float) totImmissioni / (float) totproduzione) * 100;
        float a_pro = ((float) totautoconsumo / (float) totproduzione) * 100;
        Log.i("totprdo", "" + totproduzione);
        Log.i("totpimmm", "" + totImmissioni);
        Log.i("totprdo", "" + totautoconsumo);
        Log.i("totper", "" + i_pro + ".." + a_pro);

        float Ydata[] = {i_pro, a_pro};
        ...
        PieDataSet dataset = new PieDataSet(Yvals, "PRODUZIONE " + totproduzione);
        ...
        float i_pro2 = ((float) totImmissioni2 / (float) totproduzione2) * 100;
        float a_pro2 = ((float) totautoconsumo2 / (float) totproduzione2) * 100;
        Log.i("totprdo", "" + totproduzione2);
        Log.i("totpimmm", "" + totImmissioni2);
        Log.i("totprdo", "" + totautoconsumo2);
        Log.i("totper", "" + i_pro2 + ".." + a_pro2);

        float Ydata2[] = {i_pro2, a_pro2};
        String Xdata2[] = {"Immissioni", "Autoconsumo"};
        ...
        PieDataSet dataset2 = new PieDataSet(Yvals2, "PRODUZIONE " + totproduzione2);
