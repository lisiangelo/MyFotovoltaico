...
public class FragmentAutoconsumo extends Fragment {
    Spinner anno1;
    Spinner anno2;
    LineChart chart;
    LineData data;
    TableLayout tableLayoutAutocon_prec;
    TableLayout tableLayoutAutocon_succ;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        titolo.setText("Analisi e confronto Autoconsumo");
        ...
        chart.setDescription("# dati Autoconsumo");
        chart.setBackground(getResources().getDrawable(R.drawable.sfondo_tabella));
        tableLayoutAutocon_prec = (TableLayout) rootView.findViewById(R.id.table_anno_precedente);
        tableLayoutAutocon_prec.setStretchAllColumns(true);
        tableLayoutAutocon_prec.bringToFront();
        //tableLayoutAutocon_prec.setBackgroundDrawable(getResources().getDrawable(it.android.j940549.fotovoltaico.R.drawable.bordo));


        tableLayoutAutocon_succ = (TableLayout) rootView.findViewById(R.id.table_anno_successivo);
        tableLayoutAutocon_succ.setStretchAllColumns(true);
        tableLayoutAutocon_succ.bringToFront();
       // tableLayoutAutocon_succ.setBackgroundDrawable(getResources().getDrawable(it.android.j940549.fotovoltaico.R.drawable.bordo));




        new AsyncAutoconsumo(this).execute(anno1,anno2);
    ...
    public void populateResult(LineData data, ArrayList<Dato_Tot_Tabella> datianno_prec, ArrayList<Dato_Tot_Tabella> datianno_succ) {
        ...
        for (int i=0; i<=datianno_prec.size()-2; i++) {
            ...
            tableLayoutAutocon_prec.addView(rowdato);
        }
        for (int i=0; i<=datianno_succ.size()-2; i++) {
            ...
            tableLayoutAutocon_succ.addView(rowdatos);
